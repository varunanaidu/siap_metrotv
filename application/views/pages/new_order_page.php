				...
				<div class="col-lg-6 col-7">
					<nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
						<ol class="breadcrumb breadcrumb-links breadcrumb-dark">
							...
							<li class="breadcrumb-item"><a href="<?= base_url(); ?>new_order"><?= $pagetitle; ?></a></li>
						</ol>
					</nav>
				</div>
			</div>
						...
						<div class="pl-lg-4">
							<div class="row">
								...
								<div class="col-lg-6 form-group">
									<h6 class="heading-small text-muted mb-4">Program/ Project</h6>
									<label class="form-control-label" for="">Nama Program/ Project <span class="text-red">*</span></label>
									<input type="text" id="order_name" name="order_name" class="form-control" placeholder="..." required="">
								</div>
								<div class="col-lg-3 mt-5 form-group">
									<label class="form-control-label" for="">Deadline <span class="text-red">*</span></label>
									<input type="date" id="order_deadline" name="order_deadline" class="form-control" required="">
								</div>
								<div class="col-lg-3 mt-5 form-group" id="time_container">
									...
									<div class="input-group date" id="timepicker" data-target-input="nearest">
										<input type="text" class="form-control datetimepicker-input" name="time_picker" data-target="#timepicker"/>
								...
								<div class="col-lg-12 form-group">
									...
									<textarea rows="4" id="order_brief" name="order_brief" class="form-control" placeholder="Hint Text" required=""></textarea>
								</div>
								<div class="col-lg-12 form-group" id="order_source_container">
									...
									<input type="text" id="order_source" name="order_source" class="form-control" placeholder="...">
								</div>
							</div>
							<div class="row" id="daily_item_graphic" style="height: 500px; overflow-y: auto;">
																		...
																		for ( $l = 0; $l < sizeof($item_graphic_daily[$j]['item_graphic_detail'][$k]['item_graphic_sub_detail']); $l++) { 
																			...
																			<td>
																				<!-- <div class="tooltip"> -->
																					...
																					<!-- Tooltip test -->
																					<!-- <span class="tooltiptext">Contoh tooltip</span> -->
																					<!-- </div> -->
																				</td>
																				<?php 
																				if (($l+1)%4 == 0 && $l != 0) {
																	...
																	<table class="table align-items-center table-flush">
																		<tr>
																			...
																			for ( $l = 0; $l < sizeof($item_graphic_development[$j]['item_graphic_detail'][$k]['item_graphic_sub_detail']); $l++) { 
																				...
																				?>
																				<td>
																					<input type="checkbox" name="item_graphic[<?= $index1 ?>][<?= $index2 ?>][]" value="<?= $item_graphic_development[$j]['item_graphic_detail'][$k]['item_graphic_sub_detail'][$l]['item_graphic_name'] ?>"> <?= $item_graphic_development[$j]['item_graphic_detail'][$k]['item_graphic_sub_detail'][$l]['item_graphic_name'] ?>
																				</td>
																				<?php 
																				if (($l+1)%4 == 0 && $l != 0) {
																					?>
								...
								<div class="row">
									<div id="attachment_container" class="col-lg-12 form-group">
										...
										<h5> tekan shift sambil memilih file yang ingin dilampirkan bila ingin mengupload lebih dari 1 file </h5>
										<div class="fallback">
									...
									<div class="col-lg-12 form-group">
										...
										<textarea rows="4" class="form-control" id="order_output" name="order_output" placeholder="Harap diisi untuk keterangan spesifik:ukuran/resolusi media atau bidang (HD, SD, Potrait, Landscape, Billboard, Web Banner, dll), format file(mov, dxv, mxf, html, dalet, dll)"></textarea>
									</div>
								</div>
								<div class="row align-items-center" style="position: relative;">
									<input type="text" id="id" name="id" class="collapse" value="">
									<input type="text" id="type" name="type" class="collapse" value="new">
