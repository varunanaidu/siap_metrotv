...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 24, 2021 at 01:49 PM
...
(1, 1, '4c78691c28472c7ee01b61a7c0a8b50c.jpg'),
(2, 1, '4e8d157b780dc7131dd955b2af1c7717.jpg'),
(3, 2, '39989608ef252102f4c7d81a532b319a.jpg'),
(4, 3, '6ca36c66fc836567955cfb73aace94d4.png'),
(5, 4, 'c026cceac406292b05c777d38801715b.png'),
(6, 5, '8c2ca7ad14ab94a878504a6fa4178c32.jpg'),
(7, 5, '27f3ecfc480d978fe6e31e65ad1664c6.png'),
(8, 6, '7d502f2906c2c59306686e8680527507.jpg'),
(9, 6, '27d847d52e1542036c1c51b6b73a04ba.png'),
(10, 7, 'a638703bca7fc47390832c045a7d415f.jpg'),
(11, 7, '9219513e4d76a6ab91d38a1762afa84f.jpg'),
(12, 8, '23413055a4e895fdfac7c2846197e4e9.jpg'),
(13, 8, 'e2c859591aecaa6b25fcdece3042f06d.jpg'),
(14, 9, 'aa0221ea2dca332667643d295ead0aae.jpg'),
(15, 9, 'aaee7ad313383085bd6c553e41221cf1.jpg'),
(16, 14, '5cadfbfd393d44ab1eb1ca6d13b05adc.jpg'),
(17, 14, 'bcebebc5cf8fcac6c3a98a6aa92e076e.jpg'),
(18, 22, '2455e7c0c0bf46864e007895e4f49731.jpg'),
(19, 22, 'e4f7722cde23a07df544b1a40abe6137.jpg'),
(20, 23, 'a73349f9cc116b376772807578ab4d58.jpg'),
(21, 23, '39c89d6652f0e4fbb7167ab34b0d5cff.png');
...
--
-- Dumping data for table `tr_chat_item_graphic`
--

INSERT INTO `tr_chat_item_graphic` (`chat_id`, `task_id`, `chat_desc`, `chat_sender`, `chat_sender_name`, `chat_sender_time`) VALUES
(1, 1, 'test pesan 1', 1193748, 'Seftian Alfredo', '2021-02-24 11:27:56'),
(2, 1, 'Test Pesan 2', 999999, 'Developer Metro TV', '2021-02-24 11:27:56'),
(3, 1, 'Test Pesan 3', 1193748, 'Seftian Alfredo', '2021-02-24 11:29:14'),
(4, 3, 'Test Kirim Pesan', 999999, 'Developer Metro TV', '2021-02-24 14:42:06');
...
(2, 1, 1, 1, 'Slide Medsos'),
(3, 1, 1, 2, 'Infografis Data'),
(4, 1, 2, 1, 'Wall Tematik'),
(5, 1, 2, 1, 'Ilustrasi Cetak'),
(6, 1, 2, 3, 'Logo Program'),
(7, 1, 2, 6, 'Brand Guidelines (GSM)'),
(8, 1, 3, 1, 'Aerial AR'),
(9, 1, 3, 2, 'Virtual Reality'),
(10, 1, 4, 1, 'Operational Studio 1'),
(11, 2, 1, 1, 'Infografis Data'),
(12, 2, 1, 1, 'Infografis Digital'),
(13, 2, 1, 1, 'Supers'),
(14, 2, 1, 1, 'At Large'),
(15, 2, 1, 1, 'Flashbump Hari Ini'),
(16, 2, 1, 2, 'Infografis Data'),
(17, 22, 2, 2, 'Highlight Minggu'),
(18, 22, 2, 2, 'Infografis Promo'),
(19, 22, 4, 1, 'Wireframing'),
(20, 23, 2, 1, 'Infografis Quotes'),
(21, 23, 2, 2, 'Promo Template'),
(22, 23, 2, 3, 'Logo Program'),
(23, 23, 2, 4, 'Spanduk'),
(24, 23, 2, 5, 'Strategic C Placement'),
(25, 23, 2, 6, 'Brand Guidelines (GSM)');
...
INSERT INTO `tr_order` (`order_id`, `order_type`, `order_name`, `order_deadline`, `order_brief`, `order_source`, `order_output`, `create_by`, `create_name`, `create_date`, `edited_by`, `edited_name`, `edited_date`) VALUES
(1, 1, 'Program 1', '2021-03-17', 'Brief Program 1', 'Sumber Program 1', 'Output Program 1', 1193748, 'Seftian Alfredo', '2021-02-17 13:44:27', 1193748, 'Seftian Alfredo', '2021-02-17 13:44:27'),
(2, 1, 'Headline News', '2021-02-19', 'Buat design headline news yang keren', 'youtube', 'terserah', 1193755, 'Varuna Dewi', '2021-02-19 09:42:16', 1193755, 'Varuna Dewi', '2021-02-19 09:42:16'),
(22, 2, 'Program 2', '2021-02-28', 'ewtwerwerwer', '', 'sdfsdfsdfsdf', 1193748, 'Seftian Alfredo', '2021-02-19 10:20:34', 1193748, 'Seftian Alfredo', '2021-02-19 10:20:34'),
(23, 2, 'Kick Andy', '2021-02-18', 'buat design untuk kick andy', '', 'terserah', 1193755, 'Varuna Dewi', '2021-02-19 10:22:18', 1193755, 'Varuna Dewi', '2021-02-19 10:22:18');
...
INSERT INTO `tr_task_item_graphic` (`task_id`, `item_graphics_id`, `progress`, `is_active`, `previous`, `taken_by`, `taken_name`, `taken_date`) VALUES
(1, 1, 60, 1, NULL, 1193748, 'Seftian Alfredo', '2021-02-23 14:19:00'),
(2, 2, 30, 1, NULL, 1193748, 'Seftian Alfredo', '2021-02-23 14:25:05'),
(3, 3, 0, 1, NULL, 999999, 'Developer Metro TV', '2021-02-24 10:34:19');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`dev`@`%` SQL SECURITY DEFINER VIEW `vw_chat`  AS  select `tbl1`.`order_id` AS `order_id`,`tbl1`.`order_type` AS `order_type`,`tbl1`.`order_name` AS `order_name`,`tbl1`.`order_deadline` AS `order_deadline`,`tbl1`.`order_brief` AS `order_brief`,`tbl1`.`order_source` AS `order_source`,`tbl1`.`order_output` AS `order_output`,`tbl1`.`create_by` AS `create_by`,`tbl1`.`create_name` AS `create_name`,`tbl1`.`create_date` AS `create_date`,`tbl2`.`item_graphics_id` AS `item_graphics_id`,`tbl2`.`item_graphics_type` AS `item_graphics_type`,`tbl2`.`item_graphics_sub_type` AS `item_graphics_sub_type`,`tbl2`.`item_graphics_name` AS `item_graphics_name`,`tbl3`.`task_id` AS `task_id`,`tbl3`.`progress` AS `progress`,`tbl3`.`is_active` AS `is_active`,`tbl3`.`previous` AS `previous`,`tbl3`.`taken_by` AS `taken_by`,`tbl3`.`taken_name` AS `taken_name`,`tbl3`.`taken_date` AS `taken_date`,`tbl4`.`chat_id` AS `chat_id`,`tbl4`.`chat_desc` AS `chat_desc`,`tbl4`.`chat_sender` AS `chat_sender`,`tbl4`.`chat_sender_name` AS `chat_sender_name`,`tbl4`.`chat_sender_time` AS `chat_sender_time` from (((`tr_order` `tbl1` left join `tr_item_graphics` `tbl2` on(`tbl1`.`order_id` = `tbl2`.`order_id`)) left join `tr_task_item_graphic` `tbl3` on(`tbl2`.`item_graphics_id` = `tbl3`.`item_graphics_id`)) left join `tr_chat_item_graphic` `tbl4` on(`tbl3`.`task_id` = `tbl4`.`task_id`)) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`dev`@`%` SQL SECURITY DEFINER VIEW `vw_task`  AS  select `tbl1`.`order_id` AS `order_id`,`tbl1`.`order_type` AS `order_type`,`tbl1`.`order_name` AS `order_name`,`tbl1`.`order_deadline` AS `order_deadline`,`tbl1`.`order_brief` AS `order_brief`,`tbl1`.`order_source` AS `order_source`,`tbl1`.`order_output` AS `order_output`,`tbl1`.`create_by` AS `create_by`,`tbl1`.`create_name` AS `create_name`,`tbl1`.`create_date` AS `create_date`,`tbl2`.`item_graphics_id` AS `item_graphics_id`,`tbl2`.`item_graphics_type` AS `item_graphics_type`,`tbl2`.`item_graphics_sub_type` AS `item_graphics_sub_type`,`tbl2`.`item_graphics_name` AS `item_graphics_name`,`tbl3`.`task_id` AS `task_id`,`tbl3`.`progress` AS `progress`,`tbl3`.`is_active` AS `is_active`,`tbl3`.`previous` AS `previous`,`tbl3`.`taken_by` AS `taken_by`,`tbl3`.`taken_name` AS `taken_name`,`tbl3`.`taken_date` AS `taken_date` from ((`tr_order` `tbl1` left join `tr_item_graphics` `tbl2` on(`tbl1`.`order_id` = `tbl2`.`order_id`)) left join `tr_task_item_graphic` `tbl3` on(`tbl2`.`item_graphics_id` = `tbl3`.`item_graphics_id`)) ;
...
--
ALTER TABLE `tr_item_graphics`
  MODIFY `item_graphics_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
