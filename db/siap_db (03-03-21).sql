...
--
-- Host: localhost
-- Generation Time: Mar 03, 2021 at 10:01 AM
...
CREATE TABLE `tab_user` (
  ...
  `user_type` int(11) NOT NULL COMMENT '1 = Daily; 2 = Development',
  `create_by` int(11) NOT NULL,
...
INSERT INTO `tab_user` (`user_id`, `role_id`, `user_nip`, `user_comp`, `user_name`, `user_email`, `user_phone`, `user_type`, `create_by`, `create_name`, `create_date`, `edited_by`, `edited_name`, `edited_date`) VALUES
(1, 4, 1193748, 'Metro TV', 'SEFTIAN ALFREDO', 'seftian.alfredo@metrotvnews.com', '087885803753', 0, 1193748, 'Seftian Alfredo', '2021-03-03 14:50:15', 1193748, 'Seftian Alfredo', '2021-03-03 14:50:15'),
(2, 3, 1193748, 'Metro TV', 'SEFTIAN ALFREDO', 'seftian.alfredo@metrotvnews.com', '087885803753', 0, 1193748, 'Seftian Alfredo', '2021-03-03 15:01:45', 1193748, 'Seftian Alfredo', '2021-03-03 15:01:45');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`dev`@`%` SQL SECURITY DEFINER VIEW `vw_admin`  AS  select `tbl1`.`user_id` AS `user_id`,`tbl1`.`role_id` AS `role_id`,`tbl2`.`role_name` AS `role_name`,`tbl1`.`user_nip` AS `user_nip`,`tbl1`.`user_comp` AS `user_comp`,`tbl1`.`user_name` AS `user_name`,`tbl1`.`user_email` AS `user_email`,`tbl1`.`user_phone` AS `user_phone`,`tbl1`.`user_type` AS `user_type`,`tbl1`.`create_by` AS `create_by`,`tbl1`.`create_name` AS `create_name`,`tbl1`.`create_date` AS `create_date` from (`tab_user` `tbl1` left join `tab_role` `tbl2` on((`tbl1`.`role_id` = `tbl2`.`role_id`))) where (`tbl1`.`role_id` = 3) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`dev`@`%` SQL SECURITY DEFINER VIEW `vw_all_user`  AS  select `tbl1`.`user_id` AS `user_id`,`tbl1`.`role_id` AS `role_id`,`tbl2`.`role_name` AS `role_name`,`tbl1`.`user_nip` AS `user_nip`,`tbl1`.`user_comp` AS `user_comp`,`tbl1`.`user_name` AS `user_name`,`tbl1`.`user_email` AS `user_email`,`tbl1`.`user_phone` AS `user_phone`,`tbl1`.`user_type` AS `user_type`,`tbl1`.`create_by` AS `create_by`,`tbl1`.`create_name` AS `create_name`,`tbl1`.`create_date` AS `create_date` from (`tab_user` `tbl1` left join `tab_role` `tbl2` on((`tbl1`.`role_id` = `tbl2`.`role_id`))) where (`tbl1`.`role_id` <> 4) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`dev`@`%` SQL SECURITY DEFINER VIEW `vw_client`  AS  select `tbl1`.`user_id` AS `user_id`,`tbl1`.`role_id` AS `role_id`,`tbl2`.`role_name` AS `role_name`,`tbl1`.`user_nip` AS `user_nip`,`tbl1`.`user_comp` AS `user_comp`,`tbl1`.`user_name` AS `user_name`,`tbl1`.`user_email` AS `user_email`,`tbl1`.`user_phone` AS `user_phone`,`tbl1`.`user_type` AS `user_type`,`tbl1`.`create_by` AS `create_by`,`tbl1`.`create_name` AS `create_name`,`tbl1`.`create_date` AS `create_date` from (`tab_user` `tbl1` left join `tab_role` `tbl2` on((`tbl1`.`role_id` = `tbl2`.`role_id`))) where (`tbl1`.`role_id` = 1) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`dev`@`%` SQL SECURITY DEFINER VIEW `vw_designer`  AS  select `tbl1`.`user_id` AS `user_id`,`tbl1`.`role_id` AS `role_id`,`tbl2`.`role_name` AS `role_name`,`tbl1`.`user_nip` AS `user_nip`,`tbl1`.`user_comp` AS `user_comp`,`tbl1`.`user_name` AS `user_name`,`tbl1`.`user_email` AS `user_email`,`tbl1`.`user_phone` AS `user_phone`,`tbl1`.`user_type` AS `user_type`,`tbl1`.`create_by` AS `create_by`,`tbl1`.`create_name` AS `create_name`,`tbl1`.`create_date` AS `create_date` from (`tab_user` `tbl1` left join `tab_role` `tbl2` on((`tbl1`.`role_id` = `tbl2`.`role_id`))) where (`tbl1`.`role_id` = 2) ;
...
--
ALTER TABLE `tr_item_graphics`
  MODIFY `item_graphics_id` int(11) NOT NULL AUTO_INCREMENT;
